...
if (!isset($_SESSION["user_id"])) {
  session_destroy();
  redirect('pages/functions/logout.php', 0);
  die();
}
else{
  $user_id = $_SESSION["user_id"];
  $userData = get_value("SELECT name, user_type from users WHERE id = '$user_id'");
  $userType = $userData[1];
          ...
          <div class="profile-desc">
            <div class="profile-pic">
              ...
              <div class="profile-name">
                <h5 class="mb-0 font-weight-normal"><?php echo $userData[0];?></h5>
                <span><?php echo $userData[1]; ?></span>
              </div>
            </div>
            ...
            <div class="dropdown-menu dropdown-menu-right sidebar-dropdown preview-list" aria-labelledby="profile-dropdown">
              ...
              <a href="#" class="dropdown-item preview-item" onclick="changePassword();">
                <div class="preview-thumbnail">
                  <div class="preview-icon bg-dark rounded-circle">
              ...
              <div class="dropdown-divider"></div>
              <a href="pages/functions/logout.php" class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                  <div class="preview-icon bg-dark rounded-circle">

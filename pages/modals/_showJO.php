...
$r = get_array("SELECT id, employeetbl.employee_id, contract_start, contract_end, contract_status, days, office_id, designation_id, jonamestbl.note from jonamestbl  
	...
	WHERE jotbl.jo_number = '$jo_num' ORDER BY lname, fname, mname");
	?>
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				...
				<div class="card-body">
					<div class="row">
								...
								<div class="col-lg-12 mb-2">
									...
									switch ($_SESSION['user_type']) {
										...
										switch ($get_status) {
											...
											?>
											<div class="col-lg-12 m-2">
												<a href="#" class="btn btn-lg btn-info btn-block" onclick="tagForSigningGov('<?php echo $jo_num ?>')">Tag as Signed by Governor</a>
											</div>
											<?php
											break;
										...
										if ($get_status == 1) {
											?>
											<div class="col-lg-12 m-2">
												<a href="#" class="btn btn-lg btn-info btn-block" onclick="tagApproveJO('<?php echo $jo_num ?>')">Approve JO</a>
											</div>
											<div class="col-lg-12 m-2">
												<a href="#" class="btn btn-lg btn-warning btn-block" onclick="tagdisapproveJO('<?php echo $jo_num ?>')">Disapprove JO</a>
											</div>
											<?php
										}
										?>
						...
						<div class="col-lg-10">
							<div class="card">
								<h5 class="card-header">List of Employees in this JO</h5>
								<div class="card-body">
									<div class="row">
										<div class="col-lg-12">
										...
										<div class="col-lg-12">
											<div class="table-responsive" id="joTable" style="max-height:60vh;min-height:60vh">
